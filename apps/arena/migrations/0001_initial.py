    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.IntegerField(choices=[(1, '发起挑战'), (2, '挑战进行中'), (3, '挑战完成')], default=1, verbose_name='挑战状态')),
            ],
            options={
                'verbose_name': '挑战者表',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('question_refer', models.CharField(default='', max_length=2000, verbose_name='题目参考')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_submit', models.CharField(blank=True, max_length=2000, null=True, verbose_name='用户提交代码')),
                ('submit_time', models.DateTimeField(default=datetime.datetime(2018, 9, 23, 15, 54, 42, 672875), verbose_name='用户提交时间')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_pk_info', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='user_pk_exec', to='arena.UserPkDetail', verbose_name='当前用户pk详情')),
            ],
            options={
                'verbose_name': '用户pk题目',
