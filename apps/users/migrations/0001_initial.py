...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('project_name', models.CharField(help_text='项目名', max_length=255, verbose_name='项目名')),
                ('technology', models.TextField(help_text='使用技术', verbose_name='使用技术')),
                ('project_function', models.TextField(help_text='项目功能', verbose_name='项目功能')),
                ('create', models.TextField(help_text='个人负责板块', verbose_name='个人负责板块')),
                ('time_slot', models.CharField(help_text='项目时间段', max_length=255, verbose_name='项目时间段')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('skill_name', models.CharField(help_text='技能名', max_length=255, verbose_name='技能名')),
                ('skill_level', models.CharField(choices=[('know', '了解'), ('shuxi', '熟悉'), ('skilled', '熟练'), ('master', '精通')], default='shuxi', help_text='技能等级', max_length=255, verbose_name='技能等级')),
                ('skill_introduce', models.CharField(help_text='技能介绍', max_length=255, verbose_name='技能介绍')),
                ('user', models.ForeignKey(help_text='用户名', on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL, verbose_name='用户名')),
            ],
            options={
                'verbose_name': '掌握技能',
